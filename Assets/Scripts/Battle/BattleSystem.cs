...
public class BattleSystem : MonoBehaviour
{
    ...
    public IEnumerator SetupBattle()
    {
        ...
        else
        {
            ...
            // Send out fist pokemon of trainer
    ...
    IEnumerator RunMove(BattleUnit sourceUnit, BattleUnit targetUnit, Move move)
    {
        ...
        if (CheckIfMoveHits(move, sourceUnit.Pokemon, targetUnit.Pokemon))
        {
            ...
            if (move.Base.Secondaries != null && move.Base.Secondaries.Count > 0 && targetUnit.Pokemon.HP > 0)
            {
                ...
                {
                    var randomNumber = UnityEngine.Random.Range(1, 101);
                    if (randomNumber <= secondary.Chance)
                    {
    ...
    IEnumerator RunAfterTurn(BattleUnit sourceUnit)
    {
        ...
        // Statuses as burn and poison hurt after turn
        sourceUnit.Pokemon.OnAfterTurn();
        yield return ShowStatusChanges(sourceUnit.Pokemon);
        yield return sourceUnit.Hud.UpdateHP();

        // Check for fainting due to status damage after turn
    ...
    bool CheckIfMoveHits(Move move, Pokemon source, Pokemon target)
    {
        ...
        int accuracy = source.StatBoosts[Stat.Evasion];
            ...
            while (playerUnit.Pokemon.CheckForLevelUp())
            {
                ...
                if(newMove != null)
                {
                    ...
                    else
                    {
                        ...
                        yield return dialogBox.TypeDialog($"But {playerUnit.Pokemon.Base.Name} can not learn more than {PokemonBase.MaxNumOfMoves} moves");
    ...
    void HandlePartySelection()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Z))
        {
            ...
            {
                partyScreen.SetMessageText("Youi can't send out a fainted pokemon");
                return;
            }
